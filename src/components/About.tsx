...
<motion.div 
        ...
        <div className="prose md:prose-lg max-w-none">
              ...
              >
                ...
                movement redefining what meaningful education can look like.</b> Through tutoring
                ...
                <br />
                At Knowledge Center, <b>education is not the memorization of facts</b> or a race through
                syllabi. It is the <b>training of minds to question, to build, to imagine</b>, and to keep
              ...
              <h3 className="text-2xl md:text-3xl font-heading font-bold mb-3 md:mb-4">Why we are different</h3>
                <div className="prose md:prose-lg max-w-none">
                  <motion.p 
                    ...
                    className="text-muted-foreground leading-relaxed"
                  >
                    We do more than prepare students for exams - <b>we prepare them for life</b> in a rapidly
                    changing world. While traditional systems often reward rote memorization and grade 
                    accumulation, KC prioritizes <b>conceptual understanding, creativity, and critical
                    ...
                    <b>push learners beyond comfort and into discovery.</b>
                    <br /> 
        ...
        <div className="my-14 md:my-20">
          ...
          <div className="prose md:prose-lg max-w-none">
            <p className="text-muted-foreground leading-relaxed">
              ...
              <br />
              Knowledge Center exists because this moment <b>demands a different approach to
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-16 md:mb-20">
          <Card className="shadow-elegant transition-all hover:shadow-2xl hover:-translate-y-1 bg-white/40 backdrop-blur-sm border-white/50">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                unlock global opportunities, and develop <b>leaders capable of solving Africa's most
                pressing challenges.</b>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-elegant transition-all hover:shadow-2xl hover:-translate-y-1 bg-white/40 backdrop-blur-sm border-white/50">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                <b>Re-imagining education</b> to cultivate critical 21st century competencies that empower
                and equip our local learners to <b>compete with their global peers</b> and to become the
                new drivers of <b>Africa's exponential growth.</b>
              </p>
            </CardContent>
          </Card>
        </div>
