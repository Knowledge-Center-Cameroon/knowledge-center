...
const BlogDetailPage: React.FC = () => {
  ...
  // FIX 1: All useEffect hooks are declared before any early return,
  // satisfying the React Rules of Hooks.
  ...
  // FIX 3: Use a single source of truth for the comment count shown in the
  // UI. visibleComments includes the submitting user's pending comments so the
  // count stays consistent with what is actually rendered in the list below.
  ...
  return (
    // FIX 2: Wrap in a relative-positioned div so the absolute StemBackground
    // is correctly scoped to the full page area, not the inner container.
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <Parallax ref={ref as any} style={{ y }}>
            ...
            <div className="mb-8">
              ...
              <h1 className="heading-1 mb-4 text-kc-blue">{post.title}</h1>
          ...
          >
            <div className="flex flex-wrap gap-4 items-center justify-between">
              <div className="flex gap-4">
                ...
                {/* FIX 3: Count uses approvedComments (public-facing) which is
                    intentional here — the button reflects publicly visible count. */}
          ...
          <motion.div
            ...
            className="mt-12 pt-8 border-t border-border/50"
          >
            {/* FIX 3: Heading uses visibleComments.length so it matches exactly
                what is rendered in the list (approved + current user's pending). */}
            <h3 className="heading-3 mb-6">Comments ({visibleComments.length})</h3>
